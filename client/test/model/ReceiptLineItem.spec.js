...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveOcrApiClient.ReceiptLineItem();
  });
  ...
  describe('ReceiptLineItem', function() {
    it('should create an instance of ReceiptLineItem', function() {
      ...
      //var instane = new CloudmersiveOcrApiClient.ReceiptLineItem();
      //expect(instance).to.be.a(CloudmersiveOcrApiClient.ReceiptLineItem);
    });
